 ...
 */
package org.friendularity.bind.webber.cogsim;
...
public class TestCogSim {
	...
	public static void main(String args[]) {
		try {
			...
			//CogSimConf csc = new CogSimConf();
			Properties meneProps = MeneConfig.readPropertiesFile(Communicator.thePropsPath);
			CogbotAvatar cso = CogbotService.getDefaultAvatar(meneProps);
			//CogSimOp cso = new CogSimOp(csc, null);
