/*
 *  Copyright 2013 by The Friendularity Project (www.storychat.org).
 * 
 ...
 */
package org.friendularity.gmteach.respire
...
import org.friendularity.gmteach.api.west.{ThingEstimate, WorldEstimate, WorldEstimateRenderModule}	
