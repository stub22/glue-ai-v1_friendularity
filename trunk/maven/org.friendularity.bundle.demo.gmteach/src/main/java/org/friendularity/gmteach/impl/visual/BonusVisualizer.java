...
import org.friendularity.bundle.macro.jvision.DeicticVisualizer;
import org.friendularity.gmteach.api.west.WorldEstimate;
import org.friendularity.gmteach.vworld.MeshTest;
...
public class BonusVisualizer extends ShapeAnimVisualizer<WorldEstimate> {
	...
	@Override
	public void updateDisplay(WorldEstimate we, float timePerFrame) {
