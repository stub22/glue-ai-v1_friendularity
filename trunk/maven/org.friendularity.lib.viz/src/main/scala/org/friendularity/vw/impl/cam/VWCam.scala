package org.friendularity.vw.impl.cam

import com.jme3.math.{ColorRGBA, Vector2f, Vector3f}
import com.jme3.renderer.Camera
import com.jme3.scene.control.CameraControl
import com.jme3.scene.{CameraNode, Node => JmeNode}
...
import org.friendularity.vw.mprt.manip.{AbruptManipAbsFullImpl, CamState3D, Transform3D, TransformParams3D}
import org.friendularity.vw.msg.shp.deep.{ShapeManipRqImpl, VWSCR_ExistingNode}
...
trait SyncsToCam extends AbruptlyMovable with Locatable with CamXformXtractor {
