...
public class TestOgreComplexAnimDeluxeEdition extends SimpleApplication {
    ...
    public static void main(String[] args) {
        TestOgreComplexAnimDeluxeEdition app = new TestOgreComplexAnimDeluxeEdition();
        app.start();
    }
    ...
    public void setupKeyframeAnims() {
