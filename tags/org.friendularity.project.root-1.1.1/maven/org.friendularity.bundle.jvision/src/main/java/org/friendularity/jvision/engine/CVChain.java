...
public class CVChain implements ImageStreamConsumer {
	...
	public CVChain(Model M, Resource cvchain) {
		...
		TreeMap<Integer, FilterInfo> filtersToAdd = new TreeMap<>();
		TreeMap<Integer, String> filterParms = new TreeMap<>();
	 ...
	 */
	private void init() {
		LoggerFactory.getLogger(CVChain.class.getName()).info("about to wire up imagestream");
		...
		LoggerFactory.getLogger(CVChain.class.getName()).info("done wiring up imagestream");
